...
// Di-include di setiap halaman user
...
<div class="sidebar d-flex flex-column" style="width:240px; min-width:240px;">
    <div class="brand">
        ...
        <div style="font-size:0.75rem; color:#94a3b8; font-weight:400;">Area Anggota</div>
    </div>
    ...
    <nav class="mt-2 flex-grow-1">
        ...
        <a href="<?= BASE_URL ?>/user/buku/index.php"
           class="<?= $halaman_aktif === 'buku' ? 'active' : '' ?>">
            <i class="bi bi-journal-bookmark me-2"></i> Cari Buku
        </a>
        <a href="<?= BASE_URL ?>/user/peminjaman/index.php"
